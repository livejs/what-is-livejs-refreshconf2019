...
const notes = (
  <Notes>
    ...
    <ul>
      <li>Version 1.0 from 1983, Version 2.0 currently in the works.</li>
      <li>Data Bytes</li>
...
export default (
  <Slide key={uuid()}>
    ...
    <A>
      <Title>MIDI?</Title>
      <Fragment order={1}>
        <Subtitle>Simple serial protocol</Subtitle>
      </Fragment>
      <Fragment order={2}>
        <Code>[144, 60, 127]</Code>
      </Fragment>
      <Fragment order={3}>
        <Code>[Note On + Channel 0, Mid C, Maximum Velocity]</Code>
      </Fragment>
