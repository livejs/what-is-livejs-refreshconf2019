...
export default (
  <Slide key={uuid()}>
    ...
    <A>
      <Subtitle>luminave exercises</Subtitle>
      ...
      <ImportantLink
        className="big"
        href="https://github.com/TimPietrusky/visual-and-light-workshop/blob/master/luminave.md">
        github.com/TimPietrusky/visual-and-light-workshop/blob/master/luminave.md
      </ImportantLink>
