...
export default (
  <Slide key={uuid()}>
    ...
    <A>
      <Subtitle>modV exercises</Subtitle>
      ...
      <ImportantLink
        className="big"
        href="https://github.com/TimPietrusky/visual-and-light-workshop/blob/master/modv.md">
        github.com/TimPietrusky/visual-and-light-workshop/blob/master/modv.md
      </ImportantLink>
