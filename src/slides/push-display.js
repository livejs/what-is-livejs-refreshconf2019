...
const notes = (
  <Notes>
    ...
    <ul>
      <li>
        That's why I need electron, I can directly require any node module
      </li>
      <li>usb module wraps libusb</li>
      <li>techically, Push 2 provides a composite device</li>
      <li>MIDI and generic bulk data interface</li>
    </ul>
  </Notes>
)
